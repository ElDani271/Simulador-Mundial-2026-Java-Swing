...
public class Interfaz {
    ...
    public static void frame(Grupo[] grupos, Bombo[] bombos) {
        ...
        FondoPanel panelCentro = new FondoPanel("/FaseSorteoCore/images/sorteo.png");
        ...
        startButton.addActionListener(action->{ //al presionar el boton para iniciar
            ...
            resaltarEquipo(DataSorteo.getEquipoList().get(20), panelLateral);//Resaltar otro al azar para dejar a los anfitriones descartados
    ...
    public static void mainFrame(Grupo[] grupos, Bombo[] bombos){
        ...
        FondoPanel p = new FondoPanel("/FaseSorteoCore/images/mainBackground.png");
        ...
        JButton instructBtn = new JButton("Reglas del sorteo");
        instructBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));
        instructBtn.setFocusPainted(false);


        welcomePanel.add(label);
        welcomePanel.add(startButton);
        welcomePanel.add(instructBtn);

        instructBtn.addActionListener(e -> {
            JOptionPane.showMessageDialog(null, """
                🏆 FASE DE GRUPOS
                • 4 bombos (12 equipos c/u) según ranking
                • Cada grupo: 1 equipo de cada bombo
                • UEFA: máx. 2 por grupo
                • Otras confederaciones: máx. 1 por grupo
                • Repechajes (FIFA 1 y 2): pueden ser de múltiples confederaciones
                
                ⚽ FASE ELIMINATORIA
                • Clasifican: 1° y 2° de cada grupo + 8 mejores terceros
                • 16avos: 1° vs 3°, 2° vs 2° y 1° vs 2°
                • Prohibido: equipos del mismo grupo enfrentarse
                
                🌟 TOP 4 (si son líderes)
                • España vs Argentina → Solo en la FINAL
                • Francia vs Inglaterra → Solo en la FINAL
                • Colocados en lados opuestos del bracket
                """);
            });
    ...
    private static void procesarFinBombo(JLabel labelCentro, JButton startButton, Bombo[] bombos, JPanel panelCentro_1, JButton sigEqButton, JButton autoSortButton, JPanel panelCentro_2, FondoPanel panelCentro, JPanel panelLateral, JPanel panelAbajo, Grupo[] grupos, JFrame frame1) {
        if (nBombo != 3) {
            ...
            panelCentro.setImagen("/FaseSorteoCore/images/mainBackground.png");
            frame1.revalidate();
            frame1.repaint();
